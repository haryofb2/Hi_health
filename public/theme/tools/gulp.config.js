            ...
            custom: {
                ...
                prismjs: {
                    ...
                    dist: {
                        ...
                        scripts:
                            "{$config.dist}/plugins/custom/prismjs/prismjs.bundle.js",
                    },
                },
                datatables: {
                    src: {
                ...
                leaflet: {
                    ...
                    dist: {
                        ...
                        scripts:
                            "{$config.dist}/plugins/custom/leaflet/leaflet.bundle.js",
                    },
                },
                fslightbox: {
                    src: {
                ...
                fullcalendar: {
                    src: {
                        styles: [
                            "{$config.path.node_modules}/fullcalendar/main.min.css",
                        ],
                        scripts: [
                ...
                tinymcejs: {
                    ...
                    dist: {
                        scripts:
                            "{$config.dist}/plugins/custom/tinymce/tinymce.bundle.js",
                    },
                },
                ckeditorclassic: {
                    src: {
                ...
                cropperjs: {
                    ...
                    dist: {
                        ...
                        scripts:
                            "{$config.dist}/plugins/custom/cropper/cropper.bundle.js",
                    },
                },
                jkanban: {
                    src: {
                    ...
                    dist: {
                        ...
                        scripts:
                            "{$config.dist}/plugins/custom/jkanban/jkanban.bundle.js",
                    },
                },
                flot: {
                    src: {
                ...
                jstree: {
                    ...
                    dist: {
                        ...
                        scripts:
                            "{$config.dist}/plugins/custom/jstree/jstree.bundle.js",
