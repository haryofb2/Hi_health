    ...
    <div class="d-flex align-items-center flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center flex-stack px-lg-11 mb-2" id="kt_app_header_logo">
            ...
            <a href="../dist/index.html" class="app-sidebar-logo">
                <img alt="Logo" src="{{ asset('../theme/dist/assets/media/logos/default.svg') }}"
                    class="h-30px theme-light-show" />
                <img alt="Logo" src="{{ asset('../theme/dist/assets/media/logos/default-dark.svg') }}"
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
                                ...
                                <div class="scroll-y mh-200px mh-lg-350px">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ asset('../theme/dist/assets/media/avatars/300-6.jpg') }}"
                                                alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ asset('../theme/dist/assets/media/avatars/300-2.jpg') }}"
                                                alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ asset('../theme/dist/assets/media/avatars/300-9.jpg') }}"
                                                alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ asset('../theme/dist/assets/media/avatars/300-14.jpg') }}"
                                                alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ asset('../theme/dist/assets/media/avatars/300-11.jpg') }}"
                                                alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="{{ asset('../theme/dist/assets/media/svg/brand-logos/volicity-9.svg') }}"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="{{ asset('../theme/dist/assets/media/svg/brand-logos/tvit.svg') }}"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="{{ asset('../theme/dist/assets/media/svg/misc/infography.svg') }}"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="{{ asset('../theme/dist/assets/media/svg/brand-logos/leaf.svg') }}"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="{{ asset('../theme/dist/assets/media/svg/brand-logos/tower.svg') }}"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
            ...
            <div class="app-navbar-item me-lg-1">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true"
                    ...
                    <div class="d-flex flex-column bgi-no-repeat rounded-top"
                        style="background-image:url('{{ asset('../theme/dist/assets/media/misc/menu-header-bg.jpg') }}')">
                            ...
                            <div class="d-flex flex-column px-9">
                                ...
                                <div class="text-center px-4">
                                    <img class="mw-100 mh-200px" alt="image"
                                        src="{{ asset('../theme/dist/assets/media/illustrations/sketchy-1/1.png') }}" />
                                </div>
                                <!--end::Illustration-->
                            </div>
                            <!--end::Wrapper-->
            ...
            <div class="app-navbar-item ms-3 ms-lg-4 me-lg-2" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-30px symbol-lg-40px"
                    data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                    data-kt-menu-placement="bottom-end">
                    <img src="{{ asset('../theme/dist/assets/media/avatars/300-2.jpg') }}" alt="user" />
                </div>
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <img alt="Logo"
                                    src="{{ asset('../theme/dist/assets/media/avatars/300-2.jpg') }}" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Username-->
                            <div class="d-flex flex-column">
                            ...
                            <span class="menu-title position-relative">Language
                                <span
                                    ...
                                    <img class="w-15px h-15px rounded-1 ms-2"
                                        src="{{ asset('../theme/dist/assets/media/flags/united-states.svg') }}"
                                        alt="" /></span></span>
                        </a>
                        <!--begin::Menu sub-->
                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                            ...
                            <div class="menu-item px-3">
                                <a href="../dist/account/settings.html" class="menu-link d-flex px-5">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1"
                                            src="{{ asset('../theme/dist/assets/media/flags/spain.svg') }}"
                                            alt="" />
                                    </span>Spanish</a>
                            </div>
                            <!--end::Menu item-->
                            ...
                            <div class="menu-item px-3">
                                <a href="../dist/account/settings.html" class="menu-link d-flex px-5">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1"
                                            src="{{ asset('../theme/dist/assets/media/flags/germany.svg') }}"
                                            alt="" />
                                    </span>German</a>
                            </div>
                            <!--end::Menu item-->
                            ...
                            <div class="menu-item px-3">
                                <a href="../dist/account/settings.html" class="menu-link d-flex px-5">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1"
                                            src="{{ asset('../theme/dist/assets/media/flags/japan.svg') }}"
                                            alt="" />
                                    </span>Japanese</a>
                            </div>
                            <!--end::Menu item-->
                            ...
                            <div class="menu-item px-3">
                                <a href="../dist/account/settings.html" class="menu-link d-flex px-5">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1"
                                            src="{{ asset('../theme/dist/assets/media/flags/france.svg') }}"
                                            alt="" />
                                    </span>French</a>
                            </div>
                            <!--end::Menu item-->
